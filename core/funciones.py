...
def get_datos_email_html(datos, userDestino, subject, template_name, archivo=[]):
    from pryiberoamericano.settings import EMAIL_HOST_USER
...
def custom_get_timezone(request, user=None):
    import pytz
    from pryiberoamericano.settings import TIME_ZONE
...
def addData(request, data):
    ...
    from pryiberoamericano.settings import BASE_DIR, URL_GENERAL
