...
def conferences(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            res_json.append({'error': True, "message": f"Lo sentimos, ocurrió un error enviando tu mensaje. {ex}"})
        ...
        if 'action' in request.GET:
            ...
            if action == 'catalog':
                ...
                return render(request, 'public/ES/landing/catalog.html', data)
        ...
        return render(request, 'public/ES/landing/conferences.html', data)
