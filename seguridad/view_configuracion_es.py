...
from seguridad.forms import ConfiguracionEspanolForm
from seguridad.models import ConfiguracionEspanol


@login_required
@secure_module
def configuracionEs(request):
    # if ConfiguracionEspanol.objects.count() == 0:
    #     return redirect('/admin/seguridad/configuracion/add/')
    confi = ConfiguracionEspanol.get_instancia()
    ...
    Formulario = ConfiguracionEspanolForm
